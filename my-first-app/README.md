...
now make style varibale in State
...
12.2 : add switch for dark mode
-------------------------------------------
go to https://getbootstrap.com/docs/5.3/forms/checks-radios/ & select Switches and place into Navbar.js
